...
def get_server_ip():
        try:
            response = requests.get('https://abxtest.ru/ip.txt')
...
def check_for_updates():
    ...
    github_repo_url = "https://api.github.com/repos/abiks-xakep/abx-test-project/releases/latest"
...
class Downloader(QObject):
    ...
    def download_files(self):
        try:
            ...
            url = "https://www.dropbox.com/scl/fi/x2k8k52viwryu5eobwqre/Files.zip?rlkey=jjur7wt3p028nd15724vow2z6&dl=1"
...
class MinecraftLauncher(QMainWindow):
    ...
    def save_credentials(self):
        ...
        r = requests.post('https://abxtest.ru/authenticate', data=data, headers=headers)
